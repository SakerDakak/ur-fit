...
import '../../../../modules/personal_info/widgets/equipment_item.dart';
import '../../../../modules/personal_info/widgets/shimmer_widgets/equipment_shimmer.dart';
          ...
          return Animate(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) => EquipmentItem(
                  ...
                  onTap: () => cubit.updateSelectedEquipments(state.equipments[index].id),

...
import 'package:urfit/core/shared/widgets/custom_outlined_button.dart';
  ...
  List<List<OnBoardingModel>> _splitIntoColumns(
    ...
    for (int i = 0; i < items.length; i++) {
      columns[i % columnCount].add(OnBoardingModel(
        id: 1,
        title: 'URFIT',
        text: LocaleKeys.onBording1Body,
        img: [items[i]],
        icon: AssetsManager.mini_logo,
        subtitle: LocaleKeys.onBording1Title,
      ));
    }
    return columns;
  }
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        ...
                        // if (LocaleKeys.
                        // onBording1Title.tr() != null)
                        _displaySubtitleText(LocaleKeys.onBording1Title),
                        const SizedBox(
                          height: 20,
                        ),
                        _displayText(LocaleKeys.onBording1Body.tr()),
                      ],
                    ),
                    // Expanded(
                    //   child: Align(
                    ...
                    //                 height: 20,
                    //               ),
                    //             _displayText(list[index].text.tr()),
                    //           ],
                    //         );
                    //       },
                    //     ),
                    ...
                    CustomElevatedButton(
                        text: LocaleKeys.StartYourTrip.tr(),

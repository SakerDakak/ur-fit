...
import 'package:urfit/core/api/endpoints.dart';
...
class PersonalInfoDataSourceImpl implements PersonalInfoDataSource {
  ...
  Future<List<UserGoalsModel>> getGoals() async {
    List<String> defaultImages = [
      AssetsManager.goals_nutrition,
      AssetsManager.goals_goodLook,
      AssetsManager.goals_buildMuscles,
      AssetsManager.goals_fitness,
    ];
    final res = await dioServices.get(
      EndPoints.goals,
    );

            ...
            children: [
              ...
              Row(
                ...
                children: [
                            ...
                            return Animate(
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, index) => EquipmentItem(
                                  ...
                                  onTap: () => cubit.updateSelectedMuscleFocusData(state.muscleFocusData[index].key),
                                  isSelected: state.userInfo.muscleFocusIds.contains(
                                        state.muscleFocusData[index].key,
                                      )
                                ),
                  ...
                  FittedBox(child: Image.asset(AssetsManager.bodyParts,alignment: AlignmentDirectional.topStart,)),
                ],
              ),
              // continue button
              CustomElevatedButton(

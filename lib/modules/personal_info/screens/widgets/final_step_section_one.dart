...
class _FinalStepSectionOneState extends State<FinalStepSectionOne> {
  ...
  //     // buildWhen: (p, c) =>
  //     //     p.userInfo.mealsVariantsId != c.userInfo.mealsVariantsId || p.getMealVariantsState != c.getMealVariantsState,
  //     builder: (context, state) {
  //       // if (state.getMealVariantsState == RequestState.loading || state.getMealVariantsState == RequestState.failure) {
  ...
  //           onTap: () => null, //cubit.updateSelectedMealsVariants(state.mealVariants[index].id),
  //           isSelected: state.userInfo.mealsVariantsId == state.mealVariants[index].id ||
  //               user?.mealVariety?.id == state.mealVariants[index].id,
  //         ),
  //       );
  //     },
  //   );
  ...
  //   return BlocBuilder<SetupPersonalInfoCubit, SetupPersonalInfoState>(
  //     // buildWhen: (p, c) =>
  //     //     p.userInfo.likedMealsIds != c.userInfo.likedMealsIds || p.getLikedMealsState != c.getLikedMealsState,
  //     builder: (context, state) {
  //       // if (state.getLikedMealsState == RequestState.loading || state.getLikedMealsState == RequestState.failure) {
  ...
  //               ) ||
  //               (user != null &&
  //                   user.recipeTypes != null &&
  //                   user.recipeTypes!.any((recipe) => recipe.id == state.mealsLiked[index].id)),
  //         ),
  //       );
  //     },
  //   );
  ...
  //           onTap: () => null, //cubit.updateSelectedNotLikedMeals(state.mealsNotLiked[index].id),
  //           isSelected: state.userInfo.notLikedMealsIds.contains(
  //                 state.mealsNotLiked[index].id,
  //               ) ||
  //               (user != null &&
  //                   user.foodsNotLiked != null &&
  //                   user.foodsNotLiked!.any((food) => food.id == state.mealsNotLiked[index].id)),
  //         ),
  //       );
  //     },
  //   );
  ...
  //   final user = Session().currentUser;
  //   return BlocSelector<SetupPersonalInfoCubit, SetupPersonalInfoState, double?>(
  ...
  //           onTap: () => null, //cubit.updateSelectedNoOfDailyMeals(state.noOfDailyMeals[index].value),
  ...
  //   return BlocBuilder<SetupPersonalInfoCubit, SetupPersonalInfoState>(
  //     // buildWhen: (p, c) => p.userInfo.diet_id != c.userInfo.diet_id || p.getDietOptionsState != c.getDietOptionsState,
  //     builder: (context, state) {
  //       // if (state.getDietOptionsState == RequestState.loading || state.getDietOptionsState == RequestState.failure) {
  //       //   return const ValuesGridviewShimmer();
  //       // }
  //       return ValuesGridView(

...
// {key: waist, value: waist}
    ...
    return AspectRatio(
      aspectRatio: isFemale ? 0.47 : 0.54,
    ...
    return Stack(
      ...
      children: [
        ...
        _CircleMark(
          alignment: const Alignment(-0.5, -0.53),
          size: 18,
          show: bodyPartsIds.contains('shoulders'), // left shoulder
        ),
        _CircleMark(
        ...
        _CircleMark(
          alignment: const Alignment(-0.12, -0.55),
          size: 24,
          show: bodyPartsIds.contains('chest'),
        ),
        _CircleMark(
        ...
        _CircleMark(
          alignment: const Alignment(0.2, 0.24),
          size: 22,
          show: bodyPartsIds.contains('upper legs'),
        ),
        _CircleMark(
          alignment: const Alignment(-0.38, 0.22),
          size: 22,
          show: bodyPartsIds.contains('upper legs'),
        ),
        _CircleMark(
          alignment: const Alignment(0.53, 0.65),
          size: 22,
          show: bodyPartsIds.contains('lower legs'),
        ),
        _CircleMark(
          alignment: const Alignment(-0.28, 0.63),
          size: 22,
          show: bodyPartsIds.contains('lower legs'),
        ),
      ],

                  ...
                  children: [
                    ...
                    TextSpan(
                        text: calculateBMI(cubit.state.userInfo.height ?? 0,
                                cubit.state.userInfo.currentWeight ?? 0)
                            .toStringAsFixed(1),
                        style: TStyle.primaryBold(14)
                            .copyWith(color: cubit.colorScheme.primary))
                  ],
                  style: TStyle.primaryBold(14),
                )),
                const SizedBox(height: 16),
                  ...
                  DecoratedBox(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        spacing: 6,
                        children: [
                          _guideRow('${L10n.tr().below} 18.5',
                              L10n.tr().underWeight, Colors.lightBlue),
                          _guideRow('18.5 - 24.9', L10n.tr().normalWeight,
                              Colors.green),
                          _guideRow(
                              '25 - 29.9', L10n.tr().overWeight, Colors.orange),
                          _guideRow('30 ${L10n.tr().andAbove}',
                              L10n.tr().obesity, Colors.redAccent),
                        ],
                      ),
                    ),
                  ),

...
//   //   final response = await dioServices.post(EndPoints.otpForgetPassword, data: {'email': email, 'otpCode': code});
...
//   //   try {
//   //     final response = await dioServices.post(EndPoints.forgetPassword, data: {'email': email});
//   //     return response.data;
//   //   } catch (e) {
//   //     rethrow;
//   //   }
...
//   //   final response = await _apiClient.post(EndPoints.setNewPassword, data: {
...
//   //   final response = await _apiClient.get(EndPoints.getUserTypes);
//   //   print(response.data);
//   //   return response.data;
//   // }
